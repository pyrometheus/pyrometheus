...
def generate_surface_source(generator, args):
    ...
    Each backend names the separately generated gas-phase code differently: a
    Fortran module to `use`, a C++ header to include, a Python module and class
    to annotate against.
    """
...
def main():
    ...
    if args.surface:
        ...
        # from it produces gas-phase code without saying so.
